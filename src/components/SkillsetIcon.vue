<template>
  <a :href="linkTo" target="_blank" class="group
    ...
    <div class="w-24 h-24 flex items-center justify-center p-2 sm:-translate-y-3 md:-translate-y-0  md:group-hover:-translate-y-3 transition-all border-2 border-dark-700 rounded-xl bg-dark-700">
    ...
    <span class="sm:scale-100 md:group-hover:scale-100
                 ...
                 text-dark-300
                 text-s font-bold
                 transition-all duration-100 md:scale-0 origin-top">
      {{info}}
    </span>

    <div class="flex sm:scale-100 md:group-hover:scale-100
