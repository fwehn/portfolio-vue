<template>
  <section class="w-full flex flex-col md:px-56 sm:px-5 py-32 gap-7">
    ...
    <div>
      ...
      <h2 class="text-xl font-bold">Angaben gemäß § 5 TMG</h2><br>
      ...
      <p>
        ...
        Telefon: +49 151-70388106<br>
        E-Mail: <a href='mailto:finn.wehn@web.de'>finn.wehn@web.de</a><br>
      </p><br><br>


      <h2 class="text-xl font-bold">Haftungsausschluss:</h2><br>
      <p>
